...
<html>
    <head>
      ...
      <link href="./jobListings.css" rel="stylesheet">
      ...
      <form class="form-inline">
          <div class="row">
              <div class="form-label-group space row">
                  ...
                  <select class="custom-select w-75" id="categorySelect" name="category">
                      <?php getCategories() ?>
                  </select>
              </div>
              <div class="form-label-group filter column">
                  <label for="specialization">Specialization</label>
                  <input type="select" name="specialization">
              </div>
              <div class="form-label-group filter column">
                  <label for="minimumOffer">Minimum Offer</label>
                  <input type="select" name="minimumOffer">
              </div>
          </div>
      </form>
      <br><br>
